...
import com.deb.poc.adapters.ItemsAdapter;
import com.deb.poc.adapters.SampleData;
...
//		rightAdapter = new ItemsAdapter(this, R.layout.item, rightItems);
		leftAdapter = new ItemsAdapter(this, R.layout.item, SampleData.generateLeftData(leftItems));
		rightAdapter = new ItemsAdapter(this, R.layout.item, SampleData.generateRightData(rightItems));
